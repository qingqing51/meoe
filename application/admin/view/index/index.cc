...
<script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false); function hideURLbar(){ window.scrollTo(0,1); } </script>
 <!-- Bootstrap Core CSS -->
<link href="__ADMIN__/css/bootstrap.min.css" rel='stylesheet' type='text/css' />
<!-- Custom CSS -->
...
<!-- lined-icons -->
<link rel="stylesheet" href="__ADMIN__/css/icon-font.min.css" type='text/css' />
<!-- //lined-icons -->
<script src="__ADMIN__/js/jquery-1.10.2.min.js"></script>
<script src="__ADMIN__/js/amcharts.js"></script>	
<script src="__ADMIN__/js/serial.js"></script>	
<script src="__ADMIN__/js/light.js"></script>	
<script src="__ADMIN__/js/radar.js"></script>	
<link href="__ADMIN__/css/barChart.css" rel='stylesheet' type='text/css' />
<link href="__ADMIN__/css/fabochart.css" rel='stylesheet' type='text/css' />
<!--clock init-->
<script src="__ADMIN__/js/css3clock.js"></script>
<!--Easy Pie Chart-->
<!--skycons-icons-->
<script src="__ADMIN__/js/skycons.js"></script>

<script src="__ADMIN__/js/jquery.easydropdown.js"></script>
...
<!--js -->
<link rel="stylesheet" href="__ADMIN__/css/vroom.css">
<script type="text/javascript" src="__ADMIN__/js/vroom.js"></script>
<script type="text/javascript" src="__ADMIN__/js/TweenLite.min.js"></script>
<script type="text/javascript" src="__ADMIN__/js/CSSPlugin.min.js"></script>
